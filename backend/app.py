...
model_filename = os.path.join(os.getcwd(), "/home/vikrant/Desktop/assignment8/naive_bayes_model.pkl")
tfidf_filename = os.path.join(os.getcwd(), "/home/vikrant/Desktop/assignment8/tfidf_vectorizer.pkl")
